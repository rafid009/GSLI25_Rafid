...
data = pd.read_csv("Data/pemsbay/pemsbay_norm.csv")
...
if not os.path.isdir("Data/pemsbay/mask"):
    os.makedirs("Data/pemsbay/mask")
np.savetxt("Data/pemsbay/mask/pemsbay_mask.csv", mask, fmt="%d", delimiter=",")