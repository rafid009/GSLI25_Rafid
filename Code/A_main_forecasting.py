...
parser.add_argument('--dataset', type=str, default="london", help='data set name')
parser.add_argument('--seq_len', type=int, default=96, help='input sequence length')
parser.add_argument('--pred_len', type=int, default=48, help='input sequence length')

parser.add_argument('--num_nodes', type=int, default=13, help='input node num')
parser.add_argument('--feature', type=int, default=3, help='input feature dim')
...
parser.add_argument('--mode', type=str, default="HPDP", help='spectral mode')
...
if __name__ == '__main__':
    ...
    model = A_train_forecasting.model_train(configs)
    A_train_forecasting.model_test(configs, model)
